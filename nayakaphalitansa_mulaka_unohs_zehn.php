<?php
$checkQuery = "SELECT sankhye FROM hastacalita_phalitansa_zehn WHERE sthiti='1' LIMIT 1";
...
$data = json_encode([
    ...
    "typeId" => 30,
    "language" => 0,
    "random" => "3408ab99bbd94e479035fdac81375d45",
    "signature" => "B9395DC0BC6F2D2DFC81B1A8817D8419",
    "timestamp" => time()
        ]);
        ...
        if (isset($responseData['data']['list']) && !empty($responseData['data']['list'])) {
            $defaultNumber = $responseData['data']['list'][0]['number'];
        } else {
