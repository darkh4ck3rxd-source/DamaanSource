...
$metricLabels = [
    'children_Lv_RebateAmount_Yesterday' => ['Yesterday direct commission', 'amount'],
    'children_Lv_1_RebateAmount_Yesterday' => ['Yesterday direct-level commission', 'amount'],
    'children_Lv_1_Count_Add_Yesterday' => ['Direct registrations yesterday', 'count'],
    'children_Lv_Count_X_Add_Yesterday' => ['Team registrations yesterday', 'count'],
    'children_Lv_1_RechargesSumCount' => ['Direct deposit count', 'count'],
    'children_Lv_RechargesSumCount' => ['Team deposit count', 'count'],
    'children_Lv_1_RechargesSumAmount' => ['Direct deposit amount', 'amount'],
    'children_Lv_RechargesSumAmount' => ['Team deposit amount', 'amount'],
    'children_Lv_1_FirstRechargesCount' => ['Direct first-deposit count', 'count'],
    'children_Lv_FirstRechargesCount' => ['Team first-deposit count', 'count'],
    'children_Lv_1_Count' => ['Total direct registrations', 'count'],
    'children_Lv_Count_X' => ['Total team registrations', 'count'],
    'children_Lv_1_RebateAmount_Week' => ['Direct weekly commission', 'amount'],
    'children_Lv_RebateAmount_Week' => ['Team weekly commission', 'amount'],
    'children_Lv_1_RebateAmount_X_Yesterday' => ['Direct commission yesterday (extended)', 'amount'],
    'children_Lv_RebateAmount' => ['Total team commission', 'amount'],
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $userId > 0 && $error === '') {
    ...
    try {
        ...
        $history->close();
        $values = $newValues;
        $notice = 'Agency data saved successfully for UID ' . $userId . '.';
        ...
        $error = 'Agency data could not be saved. No changes were applied.';
    }
}
