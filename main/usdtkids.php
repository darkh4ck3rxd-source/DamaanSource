...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['newupi'])) {
    ...
    if ($newRate === '' || !is_numeric($newRate) || (float)$newRate < 0) {
        ...
        $message = 'USDT rate update failed. Please try again.';
        $messageType = 'danger';
    }
}
?>
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-sm-12 mb-4 mb-xl-0">
              ...
              <?php if ($message !== ''): ?><div class="alert alert-<?= htmlspecialchars($messageType, ENT_QUOTES, 'UTF-8') ?> mt-3"><?= htmlspecialchars($message, ENT_QUOTES, 'UTF-8') ?></div><?php endif; ?>
            </div>
          </div>
          <div class="row">
