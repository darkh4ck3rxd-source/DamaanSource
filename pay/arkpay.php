...
if ($demoResult->num_rows > 0) {
    ...
    header('Location: https://mclclubvip.site/#/main');
    exit;
}
...
if (isset($_GET['tyid']) && isset($_GET['amount']) && isset($_GET['uid']) && isset($_GET['sign']) && isset($_GET['urlInfo'])) {
    ...
    if($myurl){
        ...
        // Set up parameters
        $notify_url = "https://mclclubvip.site/pay/lgwebhook.php";
...
curl_close($ch);
    ...
    $app_id = $config['app_id'];
        $params = [
            ...
            'trade_type' => 'INRUPI',
            'order_sn' => $serial,
            'return_url' => 'https://mclclubvip.site',
        ];
