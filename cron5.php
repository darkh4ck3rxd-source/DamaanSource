...
$tasks = [
    [
        'url' => 'https://jalwagams.buzz/niyamitakelasa_kemuru_funf.php',
        'interval' => '*/5 * * * *', // Every 3 minutes
    ],
    [
        'url' => 'https://jalwagams.buzz/niyamitakelasa_aidudi_funf.php',
        'interval' => '*/5 * * * *', // Every 3 minutes
    ],
    [
        'url' => 'https://jalwagams.buzz/niyamitakelasa_funf.php',
        'interval' => '*/5 * * * *', // Every 3 minutes
    ],
    [
