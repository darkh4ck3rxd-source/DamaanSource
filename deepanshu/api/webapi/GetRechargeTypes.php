				...
				if($data_auth['status'] === 'Success') {
					...
					if($sesnum == 1){
						...
						if ($payid == 2) {
                            ...
                            $data["rechargetypelist"]["0"]["paySendUrl"] = $sites."/pay/arkpay.php";
                            ...
                            $data["rechargetypelist"]["2"]["paySendUrl"] = $sites."/pay/arkpay.php";
                           ...
                           $data["rechargetypelist"]["3"]["payTypeID"] = (int)"1029";
                            ...
                            $data["rechargetypelist"]["3"]["paySendUrl"] = $sites."/pay/arkpay.php";
                            ...
                            $data["rechargetypelist"]["4"]["paySendUrl"] = $sites."/pay/arkpay.php";
                            ...
                            $data["rechargetypelist"]["0"]["maxPrice"] = (int)"50000";
                            $data["rechargetypelist"]["0"]["scope"] = "200|500|1000|5000|10000|500000";
                            $data["rechargetypelist"]["0"]["paySendUrl"] = $sites."/pay/arkpay.php";  //$sites."/#/wallet/OtherPay?type=upi";
                            $data["rechargetypelist"]["0"]["parameters"] = '';
                            $data["rechargetypelist"]["0"]["startTime"] = "00:00";
                            $data["rechargetypelist"]["0"]["endTime"] = "24:00";
                            $data["rechargetypelist"]["0"]["rechargeRifts"] = (float)"0.00";
